          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: const Color(0xFF2563EB).withOpacity(0.1), width: 1),
              ),
              child: IconButton(
          ...
          Center(
            child: ScaleTransition(
              ...
              child: AnimatedBuilder(
                animation:
                    Listenable.merge([_floatController, _pulseController]),
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              ...
                              const Color(0xFF0891B2).withOpacity(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Supports all file types • Max 100MB',
                                  style: GoogleFonts.inter(
                                      fontSize: 14,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: const Color(0xFF2563EB).withOpacity(0.08), width: 1),
              boxShadow: [
                BoxShadow(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(_getFileIcon(_selectedFile!.name),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          '${_formatFileSize(_selectedFile!.size)} • ${_selectedFile!.extension?.toUpperCase() ?? 'FILE'}',
                          style: GoogleFonts.inter(
                              fontSize: 15,
                              fontWeight: FontWeight.w400,
                              color: Theme.of(context)
              ...
              children: [
                _buildCleanSettingsTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      _buildChoicePill(
                          '${_selectedEncryption.emoji} ${_selectedEncryption.displayName}'),
                ...
                _buildCleanSettingsTile(
                  ...
                  onTap: () =>
                      setState(() => _enableCompression = !_enableCompression),
                ),
                _buildCleanSettingsTile(
                  ...
                  trailing: Transform.scale(
                    ...
                    child: Switch(
                      ...
                      onChanged: (value) =>
                          setState(() => _enableVersioning = value),
                      activeColor: const Color(0xFF2563EB),
                      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                    ),
                  ),
                  onTap: () =>
                      setState(() => _enableVersioning = !_enableVersioning),
                ),
              ],
            ),
          ),
...
Future<void> _startRealUpload() async {
  ...
  try {
    ...
    final rawHash = sha256.convert(fileBytes).toString();

    if (mounted) {
      setState(() {
        _currentStep = 1;
        _statusMessage = _uploadSteps[1];
        _uploadProgress = 0.2;
      });
    }
...
final result = await FilebaseService.uploadEncryptedFile(
  ...
  rawHash: rawHash, // 🔥 ADD THIS LINE RIGHT HERE
);
    if (result != null) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
                  ...
                  Column(
                    ...
                    children: [
                      TweenAnimationBuilder<int>(
                          ...
                          tween: IntTween(
                              begin: 0, end: (_uploadProgress * 100).round()),
                          builder: (context, value, child) {
                            return Text('$value%',
                                style: GoogleFonts.inter(
                                    fontSize: 28,
          ...
          Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: List.generate(_uploadSteps.length, (index) {
                ...
                return AnimatedContainer(
                    ...
                    width: isActive ? 20 : (isCompleted ? 16 : 6),
                    height: 2.5,
                    decoration: BoxDecoration(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
                ...
                child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        const SizedBox(width: 12),
                        Text('Blockchain Receipt (Sepolia)',
                            style: GoogleFonts.inter(
                                fontSize: 14,
                                fontWeight: FontWeight.w600,
                                color: Theme.of(context).colorScheme.onSurface))
                      ...
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            GestureDetector(
                                onTap: () async {
                                  final uri = Uri.parse(
                                      'https://sepolia.etherscan.io/tx/$_txHash');
            ...
            // 🔐 PUBLIC FILE FINGERPRINT
if (_rawHash.isNotEmpty) ...[
  const SizedBox(height: 16),
  Container(
    padding: const EdgeInsets.all(20),
    decoration: BoxDecoration(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Clipboard.setData(ClipboardData(text: _rawHash));
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Raw hash copied!'),
        ...
        const SizedBox(height: 8),
        Text(
          'Share this hash to let others verify the original file is unchanged.',
          style: GoogleFonts.inter(
            fontSize: 12,
            color: Theme.of(context)
                .colorScheme
  ...
  Widget _buildCleanSettingsTile(
  ...
  Widget _buildChoicePill(String text) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: const Color(0xFF2563EB).withOpacity(0.25), width: 1)),
      child: Text(text,
          style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w600,
  ...
  void _copyCID() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('CID copied!'), backgroundColor: Color(0xFF059669)));
  }
            ...
            child: SafeArea(
                child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      const SizedBox(height: 32),
                      Column(
                          children: EncryptionType.values
                              .map((type) => _buildEncryptionOption(type))
                              .toList())
                    ])))));
  }
                  ...
                  children: [
                    Text(type.displayName,
                        style: GoogleFonts.inter(
                            ...
                            fontWeight: FontWeight.w600,
                            color: Theme.of(context).colorScheme.onSurface)),
                    Text("Secure encryption algorithm",
                        style: GoogleFonts.inter(
                            fontSize: 12,
                            color: Theme.of(context)
                                .colorScheme
            ...
            child: SafeArea(
                child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Column(children: [
                        _buildAccessOption(
                            'Private', 'Only you', Icons.lock_rounded, true),
                        _buildAccessOption('Shared', 'Link sharing',
                            Icons.people_rounded, false),
                        _buildAccessOption(
                            'Public', 'Anyone', Icons.public_rounded, false)
                      ])
                    ])))));
  }

  Widget _buildAccessOption(
      String title, String subtitle, IconData icon, bool isAvailable) {
